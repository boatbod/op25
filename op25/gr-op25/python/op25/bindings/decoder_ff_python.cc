...
/* BINDTOOL_HEADER_FILE_HASH(308224a7010ef5c1208000dd7088239a) */
/***********************************************************************************/
...
void bind_decoder_ff(py::module &m) {
  ...
  py::class_<decoder_ff, gr::block, gr::basic_block,
      ...
      .def(py::init(&decoder_ff::make), D(decoder_ff, make))

      .def("destination", &decoder_ff::destination, D(decoder_ff, destination))

      .def("get_msgq", &decoder_ff::get_msgq, D(decoder_ff, get_msgq))

      .def("set_msgq", &decoder_ff::set_msgq, py::arg("msgq"),
