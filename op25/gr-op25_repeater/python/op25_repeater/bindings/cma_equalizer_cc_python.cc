...
/* BINDTOOL_HEADER_FILE_HASH(c5bf4f6beb65565b2596fd6f8bc48217) */
/***********************************************************************************/
...
void bind_cma_equalizer_cc(py::module &m) {
  ...
  using cma_equalizer_cc = ::gr::op25_repeater::cma_equalizer_cc;

  py::class_<cma_equalizer_cc, gr::sync_decimator,
             std::shared_ptr<cma_equalizer_cc>>(m, "cma_equalizer_cc",
                                                D(cma_equalizer_cc))

      .def(py::init(&cma_equalizer_cc::make), py::arg("num_taps"),
           py::arg("modulus"), py::arg("mu"), py::arg("sps"),
           D(cma_equalizer_cc, make))

      .def("set_taps", &cma_equalizer_cc::set_taps, py::arg("taps"),
      ...
      .def("set_gain", &cma_equalizer_cc::set_gain, py::arg("mu"),
           D(cma_equalizer_cc, set_gain))

      .def("modulus", &cma_equalizer_cc::modulus, D(cma_equalizer_cc, modulus))

      .def("set_modulus", &cma_equalizer_cc::set_modulus, py::arg("mod"),
