...
/* BINDTOOL_HEADER_FILE_HASH(8f107938145adf78888ad428d04b1783) */
/***********************************************************************************/
...
void bind_analog_udp(py::module &m) {
  ...
  py::class_<analog_udp, gr::block, gr::basic_block,
      ...
      .def(py::init(&analog_udp::make), py::arg("options"), py::arg("debug"),
           py::arg("msgq_id"), py::arg("queue"), D(analog_udp, make))

      .def("set_debug", &analog_udp::set_debug, py::arg("debug"),
