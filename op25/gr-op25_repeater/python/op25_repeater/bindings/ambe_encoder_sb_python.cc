...
void bind_ambe_encoder_sb(py::module &m) {
  ...
  py::class_<ambe_encoder_sb, gr::block, gr::basic_block,
             std::shared_ptr<ambe_encoder_sb>>(m, "ambe_encoder_sb",
                                               D(ambe_encoder_sb))

      .def(py::init(&ambe_encoder_sb::make), py::arg("versbose_flag"),
           D(ambe_encoder_sb, make))

      .def("set_gain_adjust", &ambe_encoder_sb::set_gain_adjust,
           py::arg("gain_adjust"), D(ambe_encoder_sb, set_gain_adjust))
