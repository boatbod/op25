...
void bind_iqfile_source(py::module &m) {
  ...
  py::class_<iqfile_source, gr::sync_block, gr::block, gr::basic_block,
             std::shared_ptr<iqfile_source>>(m, "iqfile_source",
                                             D(iqfile_source))

      .def(py::init(&iqfile_source::make), py::arg("itemsize"),
           py::arg("filename"), py::arg("iq_signed") = false,
           py::arg("offset") = 0, py::arg("len") = 0, D(iqfile_source, make))

      .def("seek", &iqfile_source::seek, py::arg("seek_point"),
           py::arg("whence"), D(iqfile_source, seek))

      .def("open", &iqfile_source::open, py::arg("filename"), py::arg("repeat"),
           py::arg("offset") = 0, py::arg("len") = 0, D(iqfile_source, open))

      .def("close", &iqfile_source::close, D(iqfile_source, close))

      .def("set_begin_tag", &iqfile_source::set_begin_tag, py::arg("val"),
           D(iqfile_source, set_begin_tag))

      .def("is_dsd", &iqfile_source::is_dsd, D(iqfile_source, is_dsd))
