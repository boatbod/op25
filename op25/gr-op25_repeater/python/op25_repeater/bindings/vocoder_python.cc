...
void bind_vocoder(py::module &m) {
  ...
  py::class_<vocoder, gr::block, gr::basic_block, std::shared_ptr<vocoder>>(
      m, "vocoder", D(vocoder))

      .def(py::init(&vocoder::make), py::arg("encode_flag"),
           py::arg("verbose_flag"), py::arg("stretch_amt"), py::arg("udp_host"),
           py::arg("udp_port"), py::arg("raw_vectors_flag"), D(vocoder, make))
