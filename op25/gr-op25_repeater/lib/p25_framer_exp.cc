...
bool p25_framer::nid_codeword(uint64_t acc) {
	...
	if (acc1 != acc2)
		fprintf(stderr, "p25_framer::nid_codeword: acc1=%016lx, acc2=%016lx, rc1=%d, rc2=%d\n", acc1, acc2, rc1, rc2);
	...
	if (((duid == 1) || (duid == 2) || (duid == 6) || (duid == 9) || (duid == 13) || (duid == 14)) && !cw[63])
		return false;
	else if (((duid == 0) || (duid == 3) || (duid == 4) || (duid == 5) || (duid == 7) || (duid == 8) || (duid == 10) || (duid == 11) || (duid == 12) || (duid == 15)) && cw[63])
		return false;
#endif
