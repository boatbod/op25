...
std::string DES::hex2bin(std::string s) 
{ 
...
std::string DES::bin2hex(std::string s) 
{ 
...
void DES::string2ByteArray(const std::string& s, uint8_t array[], int offset) {
...
std::string DES::byteArray2string(uint8_t array[]) {
